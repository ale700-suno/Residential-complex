...
export const metadata: Metadata = {
  ...
  description:
    '50 эксклюзивные резиденции в клубном жилом комплексе у национального парка. 5 минут до моря. Панорамные виды, бассейн, закрытая территория.',
  openGraph: {
    title: 'ARTI PARK — Премиальная недвижимость в Сочи',
    description: 'Жизнь у моря нового уровня. 50 эксклюзивные резиденции.',
