...
const faqs = [
  {
    ...
    a: 'Комплекс находится в Адлерском районе Сочи, на ул. Лазурная Долина, д.198, р-н Чайсовхоз. На границе национального парка, в 7 км от моря.',
  },
  {
    q: 'Какие площади апартаментов?',
    a: 'От компактных студий 13 м² до просторных 2-комнатных жилых помещений 44 м². Всего 50 эксклюзивные квартиры в 3 корпусах.',
  },
  {
